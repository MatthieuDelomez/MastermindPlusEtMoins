...
/*************************************************************************
 * 
 * Classe abstraite Jeu qui définit les méthodes au bon fonctionnement du
 * jeu PlusOuMoins.
 * 
...
public abstract class Jeu {
	...
	/*
	 * Variable static de type int correspondant à la longueur du code Secret.
	 */
	...
	/*
	 * Variable static correspondant au coup maximum autorisés.
	 */
	...
	public Jeu(String nomDuJeu) {
		...
		/*
		 * Variable correspondant au byte qui correspondra à la réponse qui sera appliquée au Scanner.
		 */
		byte choix = 0;
		...
		do {
			...
			/*
			 * Construction des différents modes de jeu.
			 * Si l'entrée n'est pas un byte alors invoquer la classe Erreur.
			 * 
			 * @see Erreur
			 */
			if(!sc.hasNextByte()) {
	...
	public void genererNbrSecret() {
		...
		/*
		 * Tour de boucle pour générer un chiffre aléatoirement pour atteindre la longueur
		 * qui est définie dans la variable LongueurCodeSecret.
		 */
	...
	/*
	 * Méthode servant à retourner le nom du jeu qui à été selectionner par l'utilisateur.
	 */
	...
	public void comparerNbr(Joueur joueur) {
	    ...
	    for( int i = 0; i < LongueurCodeSecret; i++) {
	    	...
	    	/*
	    	 * On gére les réponse qui seront données par le Cpu ou le Joueur.
	    	 * 
	    	 * 
	    	 */
	    ...
	    /*
	     * On gére la fin de partie avec les critères pour gagner ou perdre.
	     * 
	     * @param compteur - Score
	     * @param coupsMax - coups maximum autorisés.
	     */
	    public void finPartie(String vainqueur) {
	    if(compteur >= coupsMax && ! Joueur.proposition.equals(nbrSecret))
	    	System.out.println(

					"Vous avez atteint la limite de coups ===>" + coupsMax + "<=== ! Le nombre mystère était : " + nbrSecret + ".");
