...
public interface Observer {
	...
	/**
	 * Méthode qui permet de mettre à jour la grille de jeu en fonction des
	 * propositions et des réponses de l'ordinateur suivant le mode de jeu choisi
	 * par l'utilisateur.
	 * 
	 * @param reponse
	 *            - Correspond aux propositions et réponses de l'ordinateur.
	 */
