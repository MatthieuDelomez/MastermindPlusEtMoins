...
/** Classe qui correspond au mode de jeu Duel.
...
public class ModeDuel extends JPanel implements Observer {
	...
	private ImageIcon imgEmplacementVide=new ImageIcon("images/MastermindEmplacementVide.png"),
			...
			imgCouleurVerte=new ImageIcon("images/CouleurVerte.png"),imgCouleurBleu=new ImageIcon("images/CouleurBleu.png"),

			imgCouleurOrange=new ImageIcon("images/CouleurOrange.png"),imgCouleurRouge=new ImageIcon("images/CouleurRouge.png"),

			imgCouleurJaune=new ImageIcon("images/CouleurJaune.png"),imgCouleurViolet=new ImageIcon("images/CouleurViolet.png"),
			...
			imgEmplacementVideSolutionCombiSecreteMan=new ImageIcon("images/EmplacementVideSolutionCombiSecreteCpu.png"),

			imgCouleurGris=new ImageIcon("images/CouleurGris.png"),imgCouleurBleuFonce=new ImageIcon("images/CouleurBleuFonce.png"),

			imgCouleurNoir=new ImageIcon("images/CouleurNoir.png"),imgCouleurMarron=new ImageIcon("images/CouleurMarron.png"),

			imgEmplacementVideSolutionCombiSecreteCpu=new ImageIcon("images/MastermindEmplacementVideSolutionCombiSecreteCpu.png");
	     ...
	     tabLabelSoluceCombiSecreteCpu = new JLabel[this.nbCase];
	        ...
	        */ 
	         ...
	         tabLabelSoluceCombiSecreteMan = new JLabel[this.nbCase];
	          ...
	          /*
	           * JPanel de gauche prendra en compte les propositions du joueur et les réponses du Cpu
	           * ainsi que la combinaison secrete du Cpu.
	           */
	          ...
	          /*
	           * JPanel de droite prendra en compte les propositions du Cpu et les réponses du joueur
	           * ainsi que la combinaison secrete du joueur.
	           */
	      ...
	      bEffacerReponseMan.addActionListener(new ActionListener() {
	    	  public void actionPerformed(ActionEvent e) {
	                     ...
	                     */
	                     ...
	                     /*
	                      * La grille est organisé en GridLayout composé d'un tableau de JLabel et JPanel.
	                      */
                  ...
                  */
                   ...
                   */
                   ...
                   /**
                    * Gestion de la combinaison Secrete du Cpu. 
                    * C'est une combinaison de chiffres castés en String, chaque chiffre = couleur.
                    */
                   ...
                   private void updateCombiSecrete( int col, ImageIcon couleurChoisie, String codeCouleur) {
                	   ...
                	   if(colonneCombiSecrete < this.nbCase) {
                		   ...
                		   JOptionPane.showMessageDialog(null, "La ligne est complète. Vous pouvez soit valider, soit effacer la ligne", 
                   ...
                   /*
                    * Méthode permettant de MAJ la grille de jeu de gauche suite aux propositions de joueur.
                    * 
                  ...
                  */
                    ...
                    */
                     ...
                     /*
                      * Méthode pour MAJ la grille de jeu gauche avec les réponses du Cpu.
                      * Mais également la grille de droite avec les proposition du Cpu.
                      * 
                     ...
                     // Réinitialisation de la combinaison secrete du Cpu lorsque le mode développeur est actif.
