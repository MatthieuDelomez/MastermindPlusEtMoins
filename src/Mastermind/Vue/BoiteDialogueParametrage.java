...
/*************************************************************************
 * Classe relative la boite de dialogue qui permet d'avoir accès aux param du
 * Mastermind tels que le nombre d'essais, le nombre de cases et le nbr de
 * couleurs utilisables pour le Mastermind.
 * 
...
public class BoiteDialogueParametrage extends JDialog {
	...
	/**
	 * JPanel contenant le composant relatif au mode développeur commun aux jeux
	 * RecherchePlusMoins et Mastermind.
	 */
	...
	/**
	 * Objet permettant de charger le fichier ressources/config.properties et de
	...
	/**
	 * Flux de sortie permettant d'écrire dans le fichier
	...
	/**
	 * Nombre de valeurs possibles dans le fichier ressources/config.properties pour
	...
	/**
	 * Paramètre relatif au jeu et Mastermind. Par défaut, le mode développeur est
	 * désactivé.
	 */
	...
	/**
	 * Interface graphique de la boite de dialogue et pouvoir analyser les données
	 * du fichier ressources/config.properties et d'enregister les paramètres dans
	 * le même fichier.
	 */
	...
	/**
	 * Méthode qui servira à rendre visible la boite de dialogue. Affichage de type
	 * boolean qui permet d'indiquer si la boite sera visible ou non.
	 */
	...
	/**
	 * Accesseur permettant de récupérer la variable indiquant si le mode
	 * développeur est activé ou non.
	 * 
