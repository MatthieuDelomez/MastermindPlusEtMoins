...
public class BoiteDialogueEndOfTheGame extends JDialog {
	...
	/**
	 * Choix du joueur en fin de partie : Le joueur a le choix entre relancer le
	 * même jeu, retourner à la page d'accueil ou quitter l'application.
	 */
	...
	/**
	 * Mutateur permettant de modifier le choix effectué par le joueur en fin de
	 * partie.
	 * 
