...
public class Fenetre extends JFrame implements Observer {
	...
	/**
	 * Barre du menu Fichier = nouveau + score + quitter. A propos = Regles +
	 * Credit.
	 */
	...
	/*
	 * Champ permettant d'accéder à la fonctionnalité correspondante de
	 * l'application.
	 */
	...
	/**
	 * Flux d'entrée qui va permettre de lire le fichier
	 * ressources/config.properties
	 */
	private InputStream input;

	/**
	 * Flux de sortie qui va permettre de charger le fichier
	 * ressources/config.properties
	 */
	...
	public void initMenu() {
		...
		jmiModeDefenseur.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				container.removeAll();
				modeDefenseur = new ModeDefenseur(nbCase, nbEssai, nbCouleur, modeDeveloppeurActive,
						new DonneeMaster());
		...
		jmiRegle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, instructionJeu, "Instructions Mastermind",
	...
	/**
	 * Méthode qui permet de réinitialiser les modèles de données relatifs aux
	 * jeux..
	 */
